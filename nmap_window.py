...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_quit.setGeometry(QtCore.QRect(170, 380, 131, 51))
        ...
        self.textEdit_password.setPlaceholderText("password (kali)")
        ...
        self.textEdit_options.setPlaceholderText("options")
        self.checkBox_sC = QtWidgets.QCheckBox(self.centralwidget)
        self.checkBox_sC.setGeometry(QtCore.QRect(220, 260, 61, 41))
        self.checkBox_sC.setObjectName("checkBox_sC")
        self.checkBox_sS = QtWidgets.QCheckBox(self.centralwidget)
        self.checkBox_sS.setGeometry(QtCore.QRect(220, 310, 61, 41))
